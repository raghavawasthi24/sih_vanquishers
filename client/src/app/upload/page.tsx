  ...
  return (
    <div className=" h-full overflow-auto">
      <div className="border-dashed border-2 p-12 flex flex-col justify-center items-center gap-4">
        ...
        <p className="text-slate-500 text-center">Take your photos from blah to brilliant with our free online photo editor. Upload, edit, and share instantly from one place.</p>
        <div className="grid w-full max-w-sm items-center gap-1.5 relative">
          <Input
            id="picture"
            type="file"
            className="text-foregroundTemp hidden"
          />
